        ...
        <div
            ...
            <div className={`${SC.container} ${s.skillsContainer}`}>
                ...
                <motion.div initial="hidden"
                    ...
                    <motion.div custom={9.4} variants={animationSkills}>ESLint + Module CSS + Styled-components +
                        Tailwind
                    </motion.div>
                    <motion.div custom={10.1} variants={animationSkills}>React router + Framer-motion + Ramda + Material
                        UI
                    </motion.div>
                </motion.div>
