...
import api from '../common/img/api.png';
import controller from '../common/img/controller.png';
import jest from '../common/img/Jest.png';
import tailwind from '../common/img/tailwind.png';
import material from '../common/img/material.png';
        ...
        <div
            ...
            <div className={`${SC.container} ${s.skillsContainer}`}>
                ...
                <motion.div initial="hidden"
                    ...
                    <motion.div custom={1} variants={animationSkills}>
                        HTML
                        <span style={{ marginLeft: 13, verticalAlign: 'middle' }}>
                            <svg width="33px" height="33px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                <path
                    ...
                    <motion.div custom={2} variants={animationSkills}>
                        CSS + SСSS
                        <span style={{ marginLeft: 13, verticalAlign: 'middle' }}>
                    ...
                    <motion.div custom={3} variants={animationSkills}>
                    ...
                    <motion.div custom={4} variants={animationSkills}>
                        React + REDUX + REDUX Toolkit + REDUX Toolkit Query
                        <span style={{ marginLeft: 13, verticalAlign: 'middle' }}>
                            <svg width="33px" height="33px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <path
                    ...
                    <motion.div custom={8} variants={animationSkills}>
                        OOP + MVC
                        <span style={{ marginLeft: 13, verticalAlign: 'middle' }}>
                            <img src={controller} alt="logo" width="30" height="30" />
                        </span>
                    </motion.div>
                    ...
                    <motion.div custom={9.4} variants={animationSkills}>
                        ESLint + Module CSS + Styled-components + Tailwind
                        <span style={{ marginLeft: 13, verticalAlign: 'middle' }}>
                            <img src={tailwind} alt="logo" width="30" height="30" />
                        </span>
                    </motion.div>
                    <motion.div custom={10.1} variants={animationSkills}>
                        React router + Framer-motion + Ramda + Material UI
                        <span style={{ marginLeft: 13, verticalAlign: 'middle' }}>
                            <img src={material} alt="logo" width="30" height="30" />
                        </span>
                    </motion.div>
                </motion.div>
